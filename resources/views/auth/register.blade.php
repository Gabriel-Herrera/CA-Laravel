            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <label for="nombre" class="form-label">{{ __('First Name') }}</label>
                        ...
                        <div class="mb-3">
                            <label for="apellido" class="form-label">{{ __('Last Name') }}</label>
                        ...
                        <div class="mb-3">
                            <label for="direccion" class="form-label">{{ __('Address') }}</label>
                            <textarea id="direccion" class="form-control @error('direccion') is-invalid @enderror" name="direccion">{{ old('direccion') }}</textarea>
                            @error('direccion')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
